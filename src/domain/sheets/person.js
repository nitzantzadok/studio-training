...
const OBJECT_WORDS = [
  ...
  // שמות של לשוניות ושל קבוצות — "אימוני בוקר" הפך פעם למתאמן בשם הזה
  'אימון', 'אימוני', 'אימונים', 'תכנית', 'תכניות', 'תוכנית', 'מערך', 'בוקר', 'ערב', 'צהריים',
  'קבוצתי', 'קבוצה', 'מתקדמים', 'מתחילים', 'נשים', 'גברים', 'נוער', 'ילדים',
  'morning', 'evening', 'group', 'beginners', 'advanced',
];
